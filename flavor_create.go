...
func (flavorUtil FlavorUtil) getPlatformFlavor() ([]model.Flavor, error) {
	...
	errorMessage := "flavor_create:getPlatformFlavor() Error during creation of PLATFORM flavor"
	...
	if err != nil {
		return nil, errors.Wrap(err, errorMessage+" Error in getting PCR details")
	}
	...
	log.Printf("flavor_create:getPlatformFlavor() New Bios Section: %v", *newBios)
	...
	log.Printf("flavor_create:getPlatformFlavor() New Hardware Section: %v", *newHW)
...
func (flavorUtil FlavorUtil) getOsFlavor() ([]model.Flavor, error) {
	...
	errorMessage := "flavor_create:getOsFlavor() Error during creation of OS flavor"
	...
	log.Printf("flavor_create:getOsFlavor() New Meta Section: %v", *newMeta)
	...
	log.Printf("flavor_create:getOsFlavor() New Bios Section: %v", *newBios)
	...
	log.Printf("flavor_create:getOsFlavor() New OS Flavor: %v", osFlavor)
...
func (flavorUtil FlavorUtil) getHostUniqueFlavor() ([]model.Flavor, error) {
	...
	errorMessage := "flavor_create:getHostUniqueFlavor() Error during creation of Host Unique flavor"
	...
	log.Printf("flavor_create:getHostUniqueFlavor() New Meta Section: %v", *newMeta)
	...
	log.Printf("flavor_create:getHostUniqueFlavor() New Bios Section: %v", *newBios)
	...
	log.Printf("flavor_create:getHostUniqueFlavor() New PlatformFlavor: %v", hostUniqueFlavor)
